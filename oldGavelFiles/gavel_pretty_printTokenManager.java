/* Generated By:JavaCC: Do not edit this line. gavel_pretty_printTokenManager.java */
import java.io.*;

/** Token Manager. */
public class gavel_pretty_printTokenManager implements gavel_pretty_printConstants
{
...
/** Constructor. */
public gavel_pretty_printTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public gavel_pretty_printTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
