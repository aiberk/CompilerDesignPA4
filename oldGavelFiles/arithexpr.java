...
import java.io.*;
class arithexpr implements arithexprConstants {
    /** Main entry point. */
  public static void main(String args[]) throws ParseException, FileNotFoundException {
    ...
    arithexpr parser = new arithexpr(fileReader);
    parser.Program();
  }
...
//  E16 -> LPAREN E9 RPAREN 
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x100,0x620,};
   }
  ...
  public arithexpr(java.io.InputStream stream, String encoding) {
